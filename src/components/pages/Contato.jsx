        ...
        <section className={`section `} id="contato">
            <div className="row d-flex">
                <div className="col-md-12">
                    ...
                    <p ref={contatoRef}>Estou ansioso para discutir suas necessidades de desenvolvimento web e como posso ajudar a alcançar seus objetivos online. Entre em contato comigo hoje mesmo para iniciar essa jornada emocionante!</p>
                </div>
            </div>
            <div className="row d-flex">
